...
| --- | --- |
| Release | `Beta 0.8.15` (`0.8.15-beta.0`, Android code `815`) |
...
Beta 0.8.15 rebuilds the core vocabulary-review interaction around one compact mobile viewport: dictionary recall stays primary, examples are one reliable bilingual sentence, details remain optional, and rating controls stay fixed within thumb reach. It also removes ambiguous answer choices, repairs table-derived examples and translations, supports multi-word AI lemmas, and migrates legacy eight-word daily plans to an adjustable 20-word default. See [design-qa.md](design-qa.md) for the review record.
