...
- Local worktree: Beta 0.8.11 dictionary-first phrase review verified in browser, the installed Android release, and GitHub Actions
- Latest confirmed GitHub Actions state: CI run `29466684835` passed build, browser-QA, phrase-aware vocabulary QA, maturity regression, and Android-debug jobs for commit `e6787c2`
