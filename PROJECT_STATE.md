...
- Local worktree: Beta 0.8.12 FSRS vocabulary review verified in browser and the installed Android release; final GitHub Actions evidence will be recorded after push
- Latest confirmed GitHub Actions state before this release: CI run `29466684835` passed build, browser-QA, phrase-aware vocabulary QA, maturity regression, and Android-debug jobs for commit `e6787c2`
