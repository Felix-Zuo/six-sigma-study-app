...
const checks = [
  ...
  ["direct retrieval quiz", app.includes("选出它的常用词典义") && !app.includes('FlashReviewStage = "prompt"')],
  ...
  ["dictionary meaning separated from context", store.includes("dictionaryMeaning") && app.includes("currentFlashDictionaryMeaning") && app.includes("常用词典义")],
  ...
  ["same-session reinforcement", app.includes("currentFlashIsReinforcement") && app.includes("flashSessionRequeues") && app.includes("薄弱词会在本轮末尾")],
  ["interval previews", app.includes("previewTermReview") && app.includes("flashReviewPreviews?.remembered.intervalLabel")],
  ["progressive answer details", app.includes('className="flashMoreDetails"') && app.includes("语境、词形与 AI 补充")],
